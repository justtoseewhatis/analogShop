...
public class OrderController extends HttpServlet {
    ...
    private String completeOrder(HttpServletRequest request,
        ...
        //replace with personal email
        String from = "williemsocial@gmail.com";
        ...
        String body = "Dear " + user.getFirstName() + ",\n\n" +
            ...
            "You should receive your order in 1-3 business days. \n" + 
            "Shipped to:\n " + user.getAddress1() + "\n" +
